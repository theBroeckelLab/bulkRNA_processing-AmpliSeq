...
for (i in 1:nrow(qc.df)) {
  ...
  qc.df$mapped[i]=as.numeric(split.aligntxt[[5]][1])
  qc.df$read1[i]=as.numeric(split.aligntxt[[7]][1])
  qc.df$read2[i]=as.numeric(split.aligntxt[[8]][1])
  qc.df$properly_paired[i]=as.numeric(split.aligntxt[[9]][1])
